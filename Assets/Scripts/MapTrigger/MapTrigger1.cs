    ...
    public void tiemtrigger(int t)
    {
        switch (t)
        {
            ...
            case 60:
                ...
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_1"));
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_3", "Enemy_4", "Enemy_5"));
                break;
            case 120:
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_2"));
            ...
            case 540:
                ...
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_11"));
                break;
            case 600:
            ...
            case 660:
                ...
                break;
            case 720:
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_12"));
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_9"));
                StartCoroutine(enemyFunc.EnemyCreateFunc1(60, 1f, 1f, 1, 1, "Enemy_6", "Enemy_7", "Enemy_8"));
                break;
            case 780:
